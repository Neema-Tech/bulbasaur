  ...
  return (
    <main className="w-screen h-screen font-nexa">
      <section className="flex flex-col w-full h-full flex-column items-center pt-10">
        ...
        <p className="text-3xl font-bold text-center py-5 pb-8 md:text-[70px] md:leading-[80px]">Mau punya aplikasi reservasi pribadi?</p>
        <div className="flex flex-col justify-center items-center mt-5 w-full h-full bg-no-repeat bg-cover bg-center pb-16" style={{ backgroundImage: `url(${BookingIllustrationBg.src})` }}>
          <div className="w-full h-full max-h-[280px] relative flex justify-center items-center md:max-h-[500px]">
            <Image className="w-full h-full object-contain absolute right-4 bottom-11 md:bottom-[80px]" src={BookingIllustration.src} width={400} height={400} alt={"booking-illustration"} />
          </div>
